...
password = os.environ.get('PASSWORD', 'study123?')
...
STATIC_URL = '/static/'
STATIC_ROOT = '/home/study_system/project_api/project_api/static'  
...
# SIMPLEUI_ICON = {
#     '专业': 'fab fa-buffer',
#     '学生信息表': 'fas fa-graduation-cap',
#     '单选题库': 'fas fa-dot-circle',
#     '学生成绩': 'fas fa-feather-alt',
#     '教师信息表': 'fas fa-user-tie',
#     '学院': 'fas fa-home',
#     '试卷': 'fas fa-book-open',
# }
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://study_redis:6379",
        "OPTIONS": {
