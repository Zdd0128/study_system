...
def send_email(to_email):
    ...
    addr = 'http://127.0.0.1:8080/Email_editor_pwd'.encode()
    addr = base64.b64encode(addr)

    # 发送的消息
    message = '请在十分钟内转到此链接修改密码!---><a href=" http://127.0.0.1:8080/Email_editor_pwd">%s</a>' % addr.decode()  # 发送普通的消息使用的时候message
